            ...
            <div className="form-container">
                ...
                <div className="loginBox">
                    ...
                    <div className="entryBox">
                        ...
                        <input className="email input" type="email" value={user.email} /> {/*onChange={(e) => emailSet(e.target.value)*/}
                    </div>
                    {/* <div className="entryBox">
                    ...
                    <div className="entryBox">
                        ...
                        <input className="password input" type="text" value={user.name}/> {/*onChange={(e) => nameSet(e.target.value)*/}  
                    </div>
